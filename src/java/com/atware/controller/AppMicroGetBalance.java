...
public class AppMicroGetBalance {
    ...
    public String getBalance(String filiale, String compte, String dateDebut, String dateFin) throws IOException {
        ...
        try {
            ...
            String sql = (new StringBuilder()).append("{? = call ABI_MSRV_GETBALANCE(?,?,?)}").toString();
