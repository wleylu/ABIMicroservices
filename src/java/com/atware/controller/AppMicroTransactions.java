 ...
 */
public class AppMicroTransactions {
    public Utility utils = null;
    private DBCredential dbcnx ;
    
    @SuppressWarnings("CallToPrintStackTrace")
    public AppMicroTransactions() {
            utils = new Utility();
    ...
    public String getTransactions(TransactionInfo transact,String filiale) throws IOException {
     ...
     //   System.out.println("Filiale="+filiale);
        ...
        try {
            ...
            String sql = (new StringBuilder()).append("{? = call ABI_MSRV_POSTPAIEMENT(?,?,?,?,?,?,?,?,?,?,?,?,?)}").toString();
            ...
            try {
                ...
                cstmt.setString(2, transact.getFacturier());
                 ...
                 cstmt.setString(5, transact.getCodoper());
                 cstmt.setString(6, transact.getRefrel());
                 cstmt.setString(7, transact.getCompteDebit());
                 cstmt.setString(8, transact.getCompteCredit());
                 cstmt.setString(9, transact.getMontantDebit());
                 cstmt.setString(10, transact.getMontantCredit());
                 cstmt.setString(11, transact.getMontantCom1());
                 cstmt.setString(12, transact.getMontantCom2());
                 cstmt.setString(13, transact.getMontantTaxe());
                 cstmt.setString(14, transact.getNarratif());
                 
                boolean execute = cstmt.execute();
                result = cstmt.getString(1);
                 
            } catch (SQLException ex) {
                result = "97 Erreur de traitement";
                return result;
            }
        dbsession.close();
