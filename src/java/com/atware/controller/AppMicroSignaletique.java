 ...
 */
public class AppMicroSignaletique {
    public Utility utils = null;
    private DBCredential dbcnx ;
    
    @SuppressWarnings("CallToPrintStackTrace")
    public AppMicroSignaletique() {
            utils = new Utility();
    ...
    public String getSignaletiqueClient(String filiale, String compte, String agence) throws IOException {
        ...
        try {
            ...
            String sql = (new StringBuilder()).append("{? = call ABI_MSRV_SIGNALETIQUE(?,?)}").toString();
