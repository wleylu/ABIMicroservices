...
public class MySQLUtils {
     ...
     public  String mysql_real_escape_string(java.sql.Connection link, String str) 
           throws Exception
     {
         if (str == null) {
             return null;
     ...
     public  String quote(java.sql.Connection link, String str)
           throws Exception
     {
         if (str == null) {
             return "NULL";
     ...
     public  String nameQuote(java.sql.Connection link, String str)
           throws Exception
     {
         if (str == null) {
             return "NULL";
...
public static String addEscapeCharacter(String str){
    
    String stringWithEscapeChars = replace(str,"\'","\\\'");
    stringWithEscapeChars = replace(str,"\"","\\\"");
    
    return stringWithEscapeChars;
}
